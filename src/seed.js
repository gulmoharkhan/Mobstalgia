...
// could become. "type" doubles as a kit-size tier: 'printed' = Compact Kit
// (smaller devices), 'handcrafted' = Classic Kit (phone-sized and up).
const SAMPLE_FRAMES = [
  {
    ...
    description:
      "Inside a case smaller than a coin sits a complete computer — S3 chip, Taptic Engine, and a battery curved to fit your wrist. The Compact Kit is sized for this kind of dense, tiny architecture, so every gear-like part gets its own place under glass. If yours has been sitting in a drawer since the Series 4 came out, it's ready for a second life on your wall.",
    price: 149900,
    type: 'printed',
    status: 'available',
    stock: 30,
  ...
  },
  {
    ...
    description:
      'The N73 made a 3.2-megapixel Carl Zeiss lens something to brag about. Open it up and the board is a study in symmetry — camera module, keypad flex, and speaker sitting in near-perfect balance. This was the phone half a generation carried everywhere; taking it apart now feels like opening a time capsule.',
    price: 199900,
    type: 'handcrafted',
    status: 'available',
    stock: 25,
  ...
  },
  {
    ...
    description:
      "Glass front, glass back, and Siri talking to you for the first time — the 4S is the phone a lot of us fell for smartphones on. Inside, its glass-and-steel sandwich opens to reveal one of the most tightly engineered boards Apple ever shipped. A genuinely satisfying one to take apart.",
    price: 249900,
    type: 'handcrafted',
    status: 'available',
    stock: 25,
